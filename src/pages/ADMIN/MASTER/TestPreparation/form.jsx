            ...
            <div className="w-full bg-white rounded-lg">
                ...
                >
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-6 p-6">
                        ...
                        <Form.Item
                            label="FormTestPreparation Code"
                            name="FormTestPreparationcode"
                        // rules={[
                        //   {
                        //     required: true,
                        //     message: "Please input your FormTestPreparation Code!",
                        //   },
                        // ]}
                        >
                            <Input placeholder="Input FormTestPreparation Code" maxLength={6} />
                        </Form.Item>

                        <Form.Item
                            label="FormTestPreparation Name"
                            name="FormTestPreparationname"
                            rules={[
                                {
                                    required: true,
                                    message: "Please input your FormTestPreparation Name!",
                                },
                            ]}
                        >
                            <Input placeholder="Input FormTestPreparation Name" autoFocus />
                        </Form.Item>
